...
import { useETHReceivedFromTokens } from 'hooks/v3/contractReader/ETHReceivedFromTokens'
import useTotalBalanceOf from 'hooks/v3/contractReader/TotalBalanceOf'
import { useRedeemTokensTx } from 'hooks/v3/transactor/RedeemTokensTx'
...
export default function V2RedeemModal({
  ...
  const minReturnedTokens = distributionLimitCurrency?.eq(V3_CURRENCY_USD)
  ...
  const inUSD = distributionLimitCurrency?.eq(V3_CURRENCY_USD)
