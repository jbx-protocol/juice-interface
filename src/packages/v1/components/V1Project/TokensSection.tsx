...
import useCanPrintPreminedTokens from 'packages/v1/hooks/contractReader/useCanPrintPreminedTokens'
...
import useTotalSupplyOfProjectToken from 'packages/v1/hooks/contractReader/useTotalSupplyOfProjectToken'
