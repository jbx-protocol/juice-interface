...
export function ticketsStep({
  ...
  return {
    ...
    info: [
      ...
      '---',
      "You can propose reconfigurations to your contract's specs at any time. Your ticket holders will have 7 days to vote yay or nay. If there are 33% more yays than nays (a supermajority), the new specs will be used once the active budgeting period expires.",
    ],
  }
}
