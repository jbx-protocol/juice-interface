...
import useProjectENSName from 'hooks/v3/contractReader/ProjectENSName'
import { useProjectHandleENSTextRecord } from 'hooks/v3/contractReader/ProjectHandleENSTextRecord'
import { useEditV2ProjectHandleTx } from 'hooks/v3/transactor/EditV2ProjectHandleTx'
import { useSetENSTextRecordForHandleTx } from 'hooks/v3/transactor/SetENSTextRecordForHandleTx'
...
export function V2ProjectHandleSettingsPage() {
  const { handle, projectId } = useContext(V3ProjectContext)
