          ...
          <div className="wizard-create">
            <Wizard className="pb-28" doneText={<DeployButtonText />}>
              ...
              <Wizard.Page
                ...
                description={
                  <Trans>
                    ...
                    set period of time in which your project settings are
                    locked.{' '}
                    <ExternalLink
              ...
              <Wizard.Page
                ...
                description={
                  <Trans>
                    Design how your project's tokens should work. You can use
                    your project tokens for governance, ownership & treasury
                    redemptions.{' '}
