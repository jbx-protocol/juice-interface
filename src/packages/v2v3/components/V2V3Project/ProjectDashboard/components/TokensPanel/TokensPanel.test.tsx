...
jest.mock(
  'packages/v2v3/components/V2V3Project/ProjectDashboard/hooks/useYourBalanceMenuItems/useYourBalanceMenuItems',
  () => ({
...
jest.mock(
  'packages/v2v3/components/V2V3Project/V2V3ManageTokensSection/AccountBalanceDescription/V2V3BurnOrRedeemModal',
  () => ({
...
jest.mock(
  'packages/v2v3/components/V2V3Project/V2V3ManageTokensSection/AccountBalanceDescription/V2V3ClaimTokensModal',
  () => ({
...
jest.mock(
  'packages/v2v3/components/V2V3Project/V2V3ManageTokensSection/AccountBalanceDescription/V2V3MintModal',
  () => ({
...
jest.mock(
  'packages/v2v3/components/V2V3Project/ProjectDashboard/hooks/useTokensPanel',
)
