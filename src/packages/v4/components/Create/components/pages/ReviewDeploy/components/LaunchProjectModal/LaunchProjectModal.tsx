        ...
        {txQuoteLoading || txQuoteCost ? (
          <div className="flex items-start gap-4 py-6">
            <div className="flex-1">
              ...
              <button className="mt-1 flex h-12 w-full items-center justify-between rounded-lg border border-grey-100 bg-grey-50 px-3 text-grey-600 dark:border-slate-300 dark:bg-slate-600 dark:text-slate-100">
