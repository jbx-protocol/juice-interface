  ...
  return (
    <Html>
      <Head>
        ...
        <meta
          name="description"
          content="Fund your thing with Juicebox. The funding platform for DAOs, decentralized crowdfunding, Web3 businesses and communities. Built on Ethereum."
        />
        <meta property="og:url" content="https://juicebox.money" />
        <meta
          property="og:title"
          content="Juicebox | The Decentralized Funding Platform"
        />
        <meta
          property="og:description"
          content="The funding platform for DAOs, decentralized crowdfunding, Web3 businesses and communities. Built on Ethereum."
        />
        ...
        <link
          ...
          href="%PUBLIC_URL%/assets/juice_logo-ol.png"
        />
