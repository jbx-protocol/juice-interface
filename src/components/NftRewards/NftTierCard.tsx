    ...
    <>
      <div
        className={classNames(
          'flex h-full w-full cursor-pointer select-none flex-col shadow-smoke-300 outline-2 outline-bluebs-400 transition-shadow duration-100 hover:shadow-md dark:shadow-grey-900',
