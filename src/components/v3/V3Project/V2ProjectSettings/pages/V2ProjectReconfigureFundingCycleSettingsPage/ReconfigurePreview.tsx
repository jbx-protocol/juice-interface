...
import { getDefaultFundAccessConstraint } from 'utils/v3/fundingCycle'
...
export default function ReconfigurePreview({
  ...
  const currencyName = V3CurrencyName(
    fundAccessConstraint?.distributionLimitCurrency.toNumber() as V3CurrencyOption,
  )
