...
import { usePayETHPaymentTerminalTx } from 'hooks/v3/transactor/PayETHPaymentTerminal'
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        <Descriptions column={1} bordered size={isMobile ? 'small' : 'default'}>
          <Descriptions.Item label={t`Pay amount`} className="content-right">
            {formattedNum(usdAmount)} {V3CurrencyName(V3_CURRENCY_USD)} (
            {formatWad(weiAmount)} {V3CurrencyName(V3_CURRENCY_ETH)})
          </Descriptions.Item>
          <Descriptions.Item
