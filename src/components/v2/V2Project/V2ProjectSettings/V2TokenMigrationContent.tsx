...
import { V1TokenMigrationSetupModal } from 'components/v2/V2Project/V2ProjectToolsDrawer/V1TokenMigrationSetupSection/V1TokenMigrationSetupModal/V1TokenMigrationSetupModal'
import { V2ProjectContext } from 'contexts/v2/projectContext'
import { useV1ProjectIdOfV2Project } from 'hooks/v2/contractReader/V1ProjectIdOfV2Project'
import { useContext, useState } from 'react'

export default function V2TokenMigrationContent() {
