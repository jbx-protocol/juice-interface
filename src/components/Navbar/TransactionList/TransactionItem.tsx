...
export function TransactionItem({
  ...
  return (
    <div className="box-border flex w-full items-center justify-between gap-6 border border-grey-300 bg-smoke-25 py-1 px-5 dark:border-slate-200 dark:bg-slate-800">
