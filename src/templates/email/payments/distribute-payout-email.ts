...
const subjectTemplate =
  'A juicy update: {{ project_name }} project has sent payouts 🚀'

export const distributePayoutEmailTemplate = (
  templateData: DistributePayoutTemplateData,
) => {
