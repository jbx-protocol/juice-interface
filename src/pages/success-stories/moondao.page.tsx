    ...
    <AppWrapper>
      <CaseStudiesHeader
        ...
        summary={
          <Trans>
            ...
            while continuing to push research forward. In 2021, they launched a
            campaign to buy two tickets on a Blue Origin rocket and raised over
            $8 million on Juicebox. A year later, they sent Coby Cotton from
            viral YouTube channel Dude Perfect to space as their first
            astronaut.
          </Trans>
        }
      ...
      <CaseStudyContentContainer currentProject={moonDAOSuccessStoryProject}>
        <p>
          ...
          all of the funds. Using a reserved rate of 50%, the MoonDAO multi-sig
          received half of all newly minted tokens to build up a treasury of
          both ETH and $MOONEY that could later be used for bounties and
          compensation.
        </p>
        ...
        <div>
          ...
          <p>
            MoonDAO has built an enthusiastic community of over 10,000 members,
            successfully sent their first astronaut to space, and is currently
            coordinating the spaceflight for their second astronaut. Their
            ambitious long-term roadmap goals include building a settlement on
            the Moon by 2030. In collaboration with StudioDAO, a decentralized
            movie studio running on Juicebox, MoonDAO has donated $100,000 to
            help fund the production of Ticket To Space, the first DAO
            documentary. The film will cover the story of Yan, a MoonDAO member
            from China, who will be sent to space on an upcoming Blue Origin
            flight after minting a free NFT.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            human curiosity about what might exist beyond planet Earth. To learn
            more about the story of MoonDAO, listen to co-founders Pablo and
            Kori on episode 7 of the Juicebox podcast:{' '}
