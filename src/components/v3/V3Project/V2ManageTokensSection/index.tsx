...
import useERC20BalanceOf from 'hooks/v3/contractReader/ERC20BalanceOf'
...
import useTotalBalanceOf from 'hooks/v3/contractReader/TotalBalanceOf'
import useUserUnclaimedTokenBalance from 'hooks/v3/contractReader/UserUnclaimedTokenBalance'
import { useIssueTokensTx } from 'hooks/v3/transactor/IssueTokensTx'
import { tokenSymbolText } from 'utils/tokenSymbolText'

import TooltipIcon from 'components/TooltipIcon'
import { default as useV1HandleForProjectId } from 'hooks/v1/contractReader/HandleForProjectId'
import { useV1ProjectIdOfV2Project } from 'hooks/v3/contractReader/V1ProjectIdOfV2Project'
import { useHasV1TokenPaymentTerminal } from 'hooks/v3/hasV1TokenPaymentTerminal'
...
export default function V2ManageTokensSection() {
  ...
  const hasIssueTicketsPermission = useV3ConnectedWalletHasPermission(
    V3OperatorPermission.ISSUE,
  )
  ...
  const userHasMintPermission = Boolean(
    useV3ConnectedWalletHasPermission(V3OperatorPermission.MINT),
  )
