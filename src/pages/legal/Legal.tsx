    ...
    <div className="my-0 mx-auto max-w-5xl p-10">
      ...
      <ul className="list-disc">
        <li>
          <Trans>
            ...
            their project's legal needs with the{' '}
        ...
        <li>
          <Trans>
            To learn about the tradeoffs between different legal entities for
            web3 projects, review Paradigm's{' '}
      ...
      <p>
        <Trans>
          ...
          expert for help addressing them and identifying any further legal
          requirements.
        </Trans>
      </p>
      <ul className="list-disc">
      ...
      <ul className="list-disc">
        ...
        <li>
          <Trans>
            ...
            . This public good service is provided free-of-charge – you only
            have to pay for gas.
          </Trans>
        </li>
        <li>
        ...
        <li>
          <Trans>
            ...
            individuals within the United States set up single-member companies
            to manage payroll, benefits, and taxes. This can be a great option
            for independent DAO contributors.
          </Trans>
        </li>
      </ul>
      ...
      <ul className="list-disc">
        <li>
          <Trans>
            <ExternalLink href="https://www.openlaw.io/">OpenLaw</ExternalLink>{' '}
        ...
        <li>
          <Trans>
            <ExternalLink href="https://kali.gg/">KaliDAO</ExternalLink> has
            made several useful legal documents available on{' '}
            <ExternalLink href="https://github.com/kalidao/kali-legal">
              GitHub
            </ExternalLink>
            .
      ...
      <p className="text-secondary">
        <Trans>
          ...
          of a general nature and does not address the unique circumstances of
          any particular user. You are strongly urged to consult with your own
          legal, financial, tax, investment, and other advisors regarding all
          legal, financial, tax, and investment-related questions or concerns
          you have.
        </Trans>
      </p>
      <p className="text-secondary">
