...
import NftRewardTierModal from 'components/v3/shared/FundingCycleConfigurationDrawers/NftDrawer/NftRewardTierModal'
...
import { editingV3ProjectActions } from 'redux/slices/editingV3Project'
import {
...
export default function NftDrawer({
  ...
  } = useAppSelector(state => state.editingV3Project)
  ...
  const onNftFormSaved = useCallback(async () => {
    ...
    dispatch(editingV3ProjectActions.setNftRewardsName(collectionName))
    dispatch(
      editingV3ProjectActions.setNftRewardsSymbol(
    ...
    dispatch(editingV3ProjectActions.setNftRewardTiers(rewardTiers))
    dispatch(
      editingV3ProjectActions.setNftRewardsCollectionMetadataCID(
        nftCollectionMetadataCID,
      ),
    )
    // Store cid (link to nfts on IPFS) to be used later in the deploy tx
    dispatch(editingV3ProjectActions.setNftRewardsCIDs(rewardTiersCIDs))
