...
import { V2BalancesModal } from './V2BalancesModal'
...
const V2ProjectInfo = ({
  ...
  handleModalVisible,
  setHandleModalVisible,
}: {
  singleColumnLayout?: boolean
  expandFundingCycleCard?: boolean
  handleModalVisible?: boolean
  setHandleModalVisible?: (visible: boolean) => void
}) => {
  const {
    createdAt,
    projectId,
  ...
  return (
    <>
      ...
      />
      {setHandleModalVisible && showAddHandle && (
