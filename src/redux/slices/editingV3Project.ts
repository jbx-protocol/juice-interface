...
interface V2ProjectState {
  ...
  fundingCycleData: SerializedV3FundingCycleData
  fundingCycleMetadata: SerializedV3FundingCycleMetadata
  fundAccessConstraints: SerializedV3FundAccessConstraint[]
...
export const defaultFundingCycleData: SerializedV3FundingCycleData =
  serializeV3FundingCycleData({
...
export const defaultFundingCycleMetadata: SerializedV3FundingCycleMetadata =
  serializeV3FundingCycleMetadata({
    global: {
...
const editingV2ProjectSlice = createSlice({
  ...
  reducers: {
    ...
    setFundingCycleData: (
      state,
      action: PayloadAction<SerializedV3FundingCycleData>,
    ) => {
      state.fundingCycleData = action.payload
    },
    setFundingCycleMetadata: (
      state,
      action: PayloadAction<SerializedV3FundingCycleMetadata>,
    ) => {
    ...
    setFundAccessConstraints: (
      state,
      action: PayloadAction<SerializedV3FundAccessConstraint[]>,
    ) => {
