...
import { useDistributePayoutsTx } from 'hooks/v3/transactor/DistributePayouts'
...
import { V3CurrencyName, V3_CURRENCY_USD } from 'utils/v3/currency'
...
export default function DistributePayoutsModal({
    ...
    const txSuccessful = await distributePayoutsTx(
      {
        ...
        currency: distributionLimitCurrency.toNumber() as V3CurrencyOption,
      },
      {
        onDone: () => {
  ...
  const distributionCurrencyName = V3CurrencyName(
