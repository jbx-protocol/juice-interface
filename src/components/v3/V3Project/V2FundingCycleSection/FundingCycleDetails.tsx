...
import { V2FundingCycle, V2FundingCycleMetadata } from 'models/v3/fundingCycle'
...
import { getUnsafeV2FundingCycleProperties } from 'utils/v3/fundingCycle'
...
export default function FundingCycleDetails({
  ...
  const { tokenSymbol } = useContext(V3ProjectContext)
