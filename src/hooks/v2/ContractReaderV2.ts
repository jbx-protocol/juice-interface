...
export type ContractConfig = JuiceboxV2ContractName | Contract | undefined
...
export default function useContractReaderV2<V>({
  contract,
  functionName,
  args,
  updateOn,
  ...
  const { contracts } = useContext(UserContextV2)
