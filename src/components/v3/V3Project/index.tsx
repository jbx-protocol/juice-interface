...
import { useEditV3ProjectDetailsTx } from 'hooks/v3/transactor/EditV3ProjectDetailsTx'
...
import V2BugNotice from 'components/v3/shared/V2BugNotice'
...
import { V2BalancesModal } from './modals/V2BalancesModal/V2BalancesModal'
...
import V2ProjectHeaderActions from './V3ProjectHeaderActions'
...
export default function V3Project({
  singleColumnLayout,
  ...
  const canReconfigureFundingCycles = useV3ConnectedWalletHasPermission(
  ...
  const editV2ProjectDetailsTx = useEditV3ProjectDetailsTx()
  const hasEditPermission = useV3ConnectedWalletHasPermission(
    V3OperatorPermission.RECONFIGURE,
  )
