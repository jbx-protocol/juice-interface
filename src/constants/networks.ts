...
const SAFE_NETWORK_PREFIXES: Record<number, string> = {
  ...
  421614: 'arb1',     // Arbitrum Sepolia (uses same prefix as mainnet)
  10: 'oeth',         // Optimism
  11155420: 'oeth',   // Optimism Sepolia (uses same prefix as mainnet)
  8453: 'base',       // Base
  84532: 'base',      // Base Sepolia (uses same prefix as mainnet)
}
